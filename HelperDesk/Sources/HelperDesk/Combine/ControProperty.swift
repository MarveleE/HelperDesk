...
public extension Combine.Publishers {
    ...
    private final class Subscription<S: Subscriber, Control: UIControl, Value>: Combine.Subscription, Identifiable, Hashable where S.Input == Value {
        static func == (lhs: Subscription<S, Control, Value>, rhs: Subscription<S, Control, Value>) -> Bool {
